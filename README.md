...
- Implementation is passing the [Signature Version 4 Test Suite](https://docs.aws.amazon.com/general/latest/gr/signature-v4-test-suite.html), with the following exceptions:
...
- Implementation supports authentication using the HTTP header `Authorization`
