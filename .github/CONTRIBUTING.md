...
```sh
git clone https://github.com/<your username>/aws-signature-version-4.git
```

Navigate into the cloned directory and create a new branch:

```sh
cd aws-signature-version-4
...
[issues]: https://github.com/FantasticFiasco/aws-signature-version-4/issues
[issues_new]: https://github.com/FantasticFiasco/aws-signature-version-4/issues/new
[issues_bugs]: https://github.com/FantasticFiasco/aws-signature-version-4/issues?q=label%3Abug
[discussions]: https://github.com/FantasticFiasco/aws-signature-version-4/discussions
[discussions_new]: https://github.com/FantasticFiasco/aws-signature-version-4/discussions/new
